...
5. After `tech`: ask whether the user wants to document the database design, in the language the user is using, unless user explicitly excluded or hard trigger applies
